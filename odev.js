...
/*6*/
console.log(arr2.includes("h") ? true : false);
/*7*/
console.log(arr2.indexOf("h"));
/*8*/
console.log(arr2.slice(3, 6));
console.log(arr2.filter((e) => typeof e == "string"));
/*9*/
...
/*12*/
console.log(...arr3.filter(e => e.name == "ali"));
/*13*/
let ids = [];
arr3.map((obj) => ids = [...ids, obj.id]);
console.log(ids.reduce((acc, cur) => acc + cur));